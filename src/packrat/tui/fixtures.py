...
# last_full_scan_at, last_probe_at, probe_new_count, needs_dedup, asset_count, photos,
# videos, instance_count, last_scan_at, last_dedup_at. Order here is registration
...
ROOTS: list[dict] = [
    {
        ...
        "last_probe_at": "2026-07-15T12:00:00", "probe_new_count": 0, "needs_dedup": 0,
        # deduped, nothing new since → ◉ green.
    ...
    },
    {
        ...
        "last_probe_at": "2026-07-15T12:00:00", "probe_new_count": 0, "needs_dedup": 1,
        "asset_count": 26150, "photos": 25900, "videos": 250, "instance_count": 26150,
        "size_bytes": 148_000_000_000,
        # deduped Jul 12, then a later scan indexed new content (needs_dedup=1) → ◉ yellow (re-dedup).
    ...
    },
    {
        ...
        "last_probe_at": "2026-07-15T12:30:00", "probe_new_count": 37, "needs_dedup": 0,
    ...
    },
    {
        ...
        "last_probe_at": None, "probe_new_count": 0, "needs_dedup": 0,
    ...
    },
    {
        ...
        "enabled": 1, "last_full_scan_at": None,
        # Scanned, probe found nothing new, NEVER deduped (last_dedup_at=None) → ◉ yellow.
        "last_probe_at": "2026-07-15T12:00:00", "probe_new_count": 0, "needs_dedup": 0,
